...
export default function RedeDeApoio() {
  ...
  return (
    <>
    <Navbar/>
    <div className="bg-white text-purple-800 font-sans pt-20">
      {/* SEÇÃO HERO */}
      <section className="bg-purple-300 flex flex-col lg:flex-row items-center justify-between px-10 lg:px-24 py-16 lg:py-24 relative overflow-hidden">
        {/* Texto */}
        ...
        {/* Imagem */}
        <div className="mt-10 lg:mt-0 lg:absolute right-24 bottom-0">
          <img
            src={CardHelp}
            alt="Ilustração de apoio"
            className="w-[380px] lg:w-[440px] object-contain"
          />
        </div>
      </section>
        ...
        <div className="flex flex-col gap-4 max-w-lg">
          ...
          <p className="text-lg text-purple-900">
            Busquem Mapa de Apoio e busque pelo mapa sua necessidade
                    ...
                    {/* ÍCONE DO MAPA */}
                <div className="mt-4 cursor-pointer" onClick={() => navigate("/mapa-de-apoio")}>
                <img
                    src={IconMapa}
                    alt="Ícone de mapa"
